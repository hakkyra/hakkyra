...
// Import + re-export shared remap utilities (extracted to ../remap.ts to avoid circular coupling)
import { camelToColumnMap, remapBoolExp, resolveLimit } from '../remap.js';
export { camelToColumnMap, remapBoolExp, resolveLimit };
...
// camelToColumnMap is defined in ../remap.ts and re-exported above.
...
// remapBoolExp is defined in ../remap.ts and re-exported above.
...
// resolveLimit is defined in ../remap.ts and re-exported above.
